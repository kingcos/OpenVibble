...
object GooseOverlays {
    ...
    private val busy: List<Overlay> = run {
        ...
        listOf(
            Overlay(char = "h  ", tint = yel, path = OverlayPath.Fixed(col, row), visibility = OverlayVisibility.TickMod(8, listOf(0))),
            Overlay(char = "ho ", tint = yel, path = OverlayPath.Fixed(col, row), visibility = OverlayVisibility.TickMod(8, listOf(1))),
            Overlay(char = "hon", tint = yel, path = OverlayPath.Fixed(col, row), visibility = OverlayVisibility.TickMod(8, listOf(2))),
            Overlay(char = "onk", tint = yel, path = OverlayPath.Fixed(col, row), visibility = OverlayVisibility.TickMod(8, listOf(3))),
            Overlay(char = "nk!", tint = yel, path = OverlayPath.Fixed(col, row), visibility = OverlayVisibility.TickMod(8, listOf(4))),
            Overlay(char = "k! ", tint = yel, path = OverlayPath.Fixed(col, row), visibility = OverlayVisibility.TickMod(8, listOf(5))),
            Overlay(char = "!  ", tint = yel, path = OverlayPath.Fixed(col, row), visibility = OverlayVisibility.TickMod(8, listOf(6))),
        )
    }
    ...
    private val attention: List<Overlay> = listOf(
        Overlay(
            char = "!",
            tint = OverlayTint.Rgb565(0xF800), // RED
        ...
        Overlay(
            char = "!",
            tint = OverlayTint.Rgb565(0xFFE0), // YEL
        ...
        Overlay(
            ...
            path = OverlayPath.Fixed(col = gridCol(67 + 14), row = gridRow(6 + 8)),
    ...
    private val dizzy: List<Overlay> = run {
        ...
        listOf(
            ...
            Overlay(char = "+", tint = OverlayTint.Rgb565(0xA01F), path = OverlayPath.Baked(orbitPoints(2))), // PURPLE
        )
    }

    // HEART: 5 heart-rise streams.
