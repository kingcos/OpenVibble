...
object OwlOverlays {
    ...
    // SLEEP: three Z-streams drift up-right over 12 ticks, starting higher for a sleepier owl.
    ...
    // CELEBRATE: */o char pattern, green palette.
    ...
    private val dizzy: List<Overlay> = CapybaraOverlays.all[PersonaState.DIZZY]!!
    private val heart: List<Overlay> = CapybaraOverlays.all[PersonaState.HEART]!!
}
