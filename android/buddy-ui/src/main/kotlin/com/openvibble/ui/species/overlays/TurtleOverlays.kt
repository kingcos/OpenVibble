...
object TurtleOverlays {
    ...
    // SLEEP: three Z-streams drift up-right over 12 ticks; second z has x/2 scaling.
    ...
    // ATTENTION: note 2nd flasher x=67+6 (turtle-specific, vs cat's 67+4).
    ...
    // CELEBRATE: purple instead of green in palette slot 4.
