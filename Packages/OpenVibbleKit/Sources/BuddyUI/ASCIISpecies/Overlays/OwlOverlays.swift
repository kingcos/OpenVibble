...
enum OwlOverlays {
    ...
    // SLEEP: three Z-streams drift up-right over 12 ticks (slow, sleepy)
    // z DIM  at (67+18+p1, 6+20 - p1*2) where p1 = t%12
    // Z WHITE at (67+24+p2, 6+16 - p2)   where p2 = (t+5)%12
    // z DIM  at (67+14+p3/2, 6+12 - p3/2) where p3 = (t+9)%12
    ...
    // CYAN at (67+22, 6+14); print DOTS[t % 6]
